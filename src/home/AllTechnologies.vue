  ...
  <div>
    <div class="banner" id="header">
      ...
      <div class="container">
        ...
        <div >
          <singleCard v-once v-if="setStatus==='web_development'" :technologies="technologies" />
          <singleCard v-once v-if="setStatus==='mobile_development'" :technologies="data" />
          <singleCard v-once v-if="setStatus==='ui_ux_designs'" :technologies="data" />
          <singleCard v-once v-if="setStatus==='system_administrator'" :technologies="data" />
          <singleCard v-once v-if="setStatus==='lower_level_programming'" :technologies="data" />
        </div>
      </div>
    </div>
